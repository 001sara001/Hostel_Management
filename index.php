...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Hostel Management</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
        Note: Your details must match with your ID(NID,passport,driving lisence etc)
              ...
              <form>
               <div class="row align-item-end">
                 <div class="col-lg-3 mb-3">
                    <label class="form-label" style="font-weigth:500;" >Check-in</label>
                    <input type="date" class="form-control shadow-none" >
                 </div>
                 <div class="col-lg-3 mb-3">
                    <label class="form-label" style="font-weigth:500;" >Check-out</label>
                    <input type="date" class="form-control shadow-none" >
                 </div>
                    <div class="col-lg-3 mb-3">
      ...
      <div class="swiper-slide bg-white p-4">
        <div class="profile mb-3">
          ...
          <p>
            ...
            Animi neque explicabo architecto nisi earum! 
            Dolore quibusdam velit nihil ratione fugiat.
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>  
    ...
    <div class="container-fluid bg-white mt-5">
       <div class="row">
           <div class="col-lg-4 p-4">
               <h3 class="h-font fw-bold fs-3 mb-2">Hostel Management</h3>   
               <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Ex recusandae perferendis necessitatibus libero qui assumenda nostrum? 
                Porro doloremque fuga fugiat.
               </p>
           </div>
           <div class="col-lg-4 p-4">
