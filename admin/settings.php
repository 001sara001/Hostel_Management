...
<body class="bg-white">
         ...
         <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <div class="card border-0 shadow-sm mb-4">
               <div class="card-body">
                  ...
                  <p class="card-text">
                     No customers will be allwoed to book hostel rooms
                  </p>
               </div>
            </div>
   ...
   <script>
      ...
      general_s_form.addEventListener('submit', function(e) {
         e.preventDefault(); //for stopping refresh
      ...
      function get_contacts() {
         ...
         xhr.onload = function() {
            ...
            contacts_data = Object.values(contacts_data); //just for getting the values
      ...
      function upd_contacts() {
         ...
         xhr.onload = function() {
            var myModal = document.getElementById('contacts-s'); //just id fetching
            var modal = bootstrap.Modal.getInstance(myModal);
            modal.hide(); //for hiding the modal after submitting
            if (this.responseText == 1) {
               alert('success', 'Changes saved!');
      ...
      team_s_form.addEventListener('submit', function(e) {
         e.preventDefault();
         add_member(); //EKHANE CHANGE KORSILAM !!!!!!!!!!!!
      });
      ...
      function add_member() {
         ...
         xhr.onload = function() {
            var myModal = document.getElementById('team-s'); //just id fetching
            var modal = bootstrap.Modal.getInstance(myModal);
            modal.hide(); //for hiding the modal after submitting
